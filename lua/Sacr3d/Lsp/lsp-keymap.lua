...
map('n', '<space>l', '<cmd>lua vim.diagnostic.open_float()<CR>', opts)
map('n', '<space>{', '<cmd>lua vim.diagnostic.goto_prev()<CR>', opts)
map('n', '<space>}', '<cmd>lua vim.diagnostic.goto_next()<CR>', opts)
map('n', '<M-q>', '<cmd>lua vim.diagnostic.setloclist()<CR>', opts)
-- map('n', '<space>k', '<cmd>lua vim.diagnostic.show()<CR>', opts)
